...
public class IdentifierPatternToFileResourceUriResolvingUtilTest {
  ...
  public void findValidKeys() throws Exception {
    ...
    IdentifierPatternToFileResourceUriResolvingUtil util = new IdentifierPatternToFileResourceUriResolvingUtil(resolvedFileResourcesConfig);
  ...
  public void testSplitEqually() {
    ...
    String[] result = IdentifierPatternToFileResourceUriResolvingUtil.splitEqually("Thequickbrownfoxjumps", 4);
  ...
  public void testGetSplittedUuidPath() {
    ...
    String result = IdentifierPatternToFileResourceUriResolvingUtil.getSplittedUuid("c30cf362-5992-4f5a-8de0-61938134e721");
